package src.ncu.java;
import java.io.File;  // Import the File class
import java.io.FileNotFoundException;  // Import this class to handle errors
import java.util.Properties;
import java.util.Scanner; // Import the Scanner class to read text files

import src.ncu.exceptions.*;
...
class showOutput
{
 ...
 try {  //to read data from file
      File myObj = new File("D:\\Team57\\txt\\diseases\\heart attack.txt");
   ...
   try{ FileInputStream input=new FileInputStream("D:\\Team57\\configs\\constants\\exception.properties");
    ...
    { 
 try {
      File myObj = new File("D:\\Team57\\txt\\diseases\\pneumonia.txt");
      Scanner myReader = new Scanner(myObj);
      while (myReader.hasNextLine()) {
...
c1.WriteTOCsv(data[3],d2);}
    ...
    {
 try {
      File myObj = new File("D:\\Team57\\txt\\diseases\\lung cancer.txt");
      Scanner myReader = new Scanner(myObj);
      while (myReader.hasNextLine()) {
        for (int i=0;i<8;i++)
        {
    ...
    {
 try {
      File myObj = new File("D:\\Team57\\txt\\diseases\\bladder diseases.txt");
      Scanner myReader = new Scanner(myObj);
      while (myReader.hasNextLine()) {
        for (int i=0;i<8;i++)
        {
...
c1.WriteTOCsv(data[3],d4);}
    ...
    {
 try {
      File myObj = new File("D:\\Team57\\txt\\diseases\\liver diseases.txt");
      Scanner myReader = new Scanner(myObj);
      while (myReader.hasNextLine()) {
        for (int i=0;i<8;i++)
        {
    ...
    {
 try {
      File myObj = new File("D:\\Team57\\txt\\diseases\\skin cancer.txt");
      Scanner myReader = new Scanner(myObj);
      while (myReader.hasNextLine()) {
        for (int i=0;i<8;i++)
        {
    ...
    {
 try {
      File myObj = new File("D:\\Team57\\txt\\diseases\\headache disorder.txt");
      Scanner myReader = new Scanner(myObj);
      while (myReader.hasNextLine()) {
        for (int i=0;i<8;i++)
        {
    ...
    {
 try {
      File myObj = new File("D:\\Team57\\txt\\diseases\\osteoatharitis.txt");
      Scanner myReader = new Scanner(myObj);
      while (myReader.hasNextLine()) {
        for (int i=0;i<8;i++)
        {
    ...
    {
 try {
      File myObj = new File("D:\\Team57\\txt\\diseases\\anorexia nervosa.txt");
      Scanner myReader = new Scanner(myObj);
      while (myReader.hasNextLine()) {
        for (int i=0;i<8;i++)
        {
    ...
    {
 try {
      File myObj = new File("D:\\Team57\\txt\\diseases\\gallstones.txt");
      Scanner myReader = new Scanner(myObj);
 ...
 { 
   ...
   if(symptom.equals(d1)==true)
    {
 try {  //to read data from file
      File myObj = new File("D:\\Team57\\txt\\symptom\\chest pain.txt");
      Scanner myReader = new Scanner(myObj);
      while (myReader.hasNextLine()) {
        for (int i=0;i<4;i++)
        {
...
c1.WriteTOCsv(d1,data[1]);}
    ...
    {
 try {
      File myObj = new File("D:\\Team57\\txt\\symptom\\shortness of breathe.txt");
      Scanner myReader = new Scanner(myObj);
      while (myReader.hasNextLine()) {
        for (int i=0;i<4;i++)
        {
...
c1.WriteTOCsv(d2,data[1]);}
    ...
    {
 try {
      File myObj = new File("D:\\Team57\\txt\\symptom\\cough.txt");
      Scanner myReader = new Scanner(myObj);
      while (myReader.hasNextLine()) {
        for (int i=0;i<4;i++)
        {
...
c1.WriteTOCsv(d3,data[1]);}
    ...
    {
 try {
      File myObj = new File("D:\\Team57\\txt\\symptom\\vomiting.txt");
      Scanner myReader = new Scanner(myObj);
      while (myReader.hasNextLine()) {
        for (int i=0;i<4;i++)
        {
...
c1.WriteTOCsv(d4,data[1]);}
    ...
    {
 try {
      File myObj = new File("D:\\Team57\\txt\\symptom\\fatique.txt");
      Scanner myReader = new Scanner(myObj);
      while (myReader.hasNextLine()) {
         for (int i=0;i<4;i++)
        {
...
c1.WriteTOCsv(d5,data[1]);}
    ...
    {
 try {
      File myObj = new File("D:\\Team57\\txt\\symptom\\sweating.txt");
      Scanner myReader = new Scanner(myObj);
      while (myReader.hasNextLine()) {
        for (int i=0;i<4;i++)
        {
...
c1.WriteTOCsv(d6,data[1]);}
    ...
    {
 try {
      File myObj = new File("D:\\Team57\\txt\\symptom\\loss of appetite.txt");
      Scanner myReader = new Scanner(myObj);
      while (myReader.hasNextLine()) {
        for (int i=0;i<4;i++)
        {
...
c1.WriteTOCsv(d7,data[1]);}
    ...
    {
 try {
      File myObj = new File("D:\\Team57\\txt\\symptom\\unconciousness.txt");
      Scanner myReader = new Scanner(myObj);
      while (myReader.hasNextLine()) {
        for (int i=0;i<4;i++)
        {
...
c1.WriteTOCsv(d8,data[1]);}
    ...
    {
 try {
      File myObj = new File("D:\\Team57\\txt\\symptom\\fainting.txt");
      Scanner myReader = new Scanner(myObj);
      while (myReader.hasNextLine()) {
        for (int i=0;i<4;i++)
        {
...
c1.WriteTOCsv(d9,data[1]);}
    ...
    {
 try {
      File myObj = new File("D:\\Team57\\txt\\symptom\\headache.txt");
      Scanner myReader = new Scanner(myObj);
      while (myReader.hasNextLine()) {
        for (int i=0;i<4;i++)
        {
