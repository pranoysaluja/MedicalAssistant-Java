package src.ncu.main;  //create main package
import src.ncu.java.*;  // importing java files
import src.ncu.validations.*;  //for validation such as age,contactno.,etc
import java.util.Scanner;    //for taking input from user
import java.util.Formatter;   //for format of registration panel
import src.ncu.exceptions.*;  //importing exceptions
